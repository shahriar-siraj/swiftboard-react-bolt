          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-gray-900 dark:text-white focus:border-primary-500 focus:ring-primary-500"
            ...
            <div>
              <label htmlFor="expectedLaunchDate" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Expected Launch Date <span className="text-sm text-gray-500">(optional)</span>
              </label>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, status: e.target.value as 'pre_launch' | 'launched' }))}
                  className="block w-full pl-10 pr-3 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:border-primary-500 focus:ring-primary-500"
                >
